...
$buildScript = Join-Path $projectPath -ChildPath "default.ps1"
Invoke-WebRequest "https://raw.githubusercontent.com/melkio/scripts/master/default.ps1" -OutFile $buildScript
